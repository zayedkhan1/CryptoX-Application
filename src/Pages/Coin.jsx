    ...
    <div className='text-white p-6'>
      <div className="min-h-screen  text-white flex flex-col items-center px-4 py-8">
        <div className="flex flex-col items-center space-y-4 mb-4">
          ...
          <img className='w-[110px]' src={coinData?.image?.large} alt="" />


          <h1 className="text-4xl md:text-4xl font-bold">{coinData?.name} ({coinData?.symbol.toUpperCase()}) </h1>
        </div>

        {/* Graph Section */}
        <div className="mt-8  w-full max-w-2xl bg-white rounded-xl shadow-lg p-4">
