...
const Home = () => {
  ...
  return (
    <div >
      {/*  */}
      <section className="w-full h-100 flex flex-col items-center justify-center  px-4 text-center">
        <div className="w-11/12 sm:w-10/12 md:w-8/12 lg:w-6/12 mx-auto flex flex-col items-center gap-4 mb-8 py-2">
          <h2 className="text-xl md:text-6xl font-bold text-white mb-4">
            <span className="block mb-3">Largest</span>
